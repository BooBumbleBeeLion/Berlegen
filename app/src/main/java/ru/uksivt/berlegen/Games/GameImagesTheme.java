...
//                break;
        ...
        rawBash = getResources().getIdentifier("profbash" + countBash,"raw",this.getPackageName());
        rawRus = getResources().getIdentifier("profrus" + countRus, "raw", this.getPackageName());
